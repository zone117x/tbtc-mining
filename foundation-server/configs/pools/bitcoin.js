...
config.primary.coin.mainnet.bip32.public = Buffer.from(
  "0488B21E",
  "hex"
).readUInt32LE(0);
config.primary.coin.mainnet.bip32.private = Buffer.from(
  "0488ADE4",
  "hex"
).readUInt32LE(0);
...
config.primary.coin.testnet.bip32.public = Buffer.from(
  "043587CF",
  "hex"
).readUInt32LE(0);
config.primary.coin.testnet.bip32.private = Buffer.from(
  "04358394",
  "hex"
).readUInt32LE(0);
